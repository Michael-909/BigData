...
namespace BigData.Repositories
{
    public class DmBhaOpTRepository
    {
        ...
        {
            var model = JsonConvert.DeserializeObject<DmBhaOpT>(jsonData);
            model.BhaOpId = NormalHelper.GenerateNormalKey();
            dbContext.DmBhaOpT.Add(model);
        ...
        public bool Update(string Id, string jsonData)
        {
            ...
            model = JsonConvert.DeserializeObject<DmBhaOpT>(jsonData);
